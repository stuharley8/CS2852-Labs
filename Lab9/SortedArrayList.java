...
public class SortedArrayList<E extends Comparable<? super E>>
        extends ArrayList<E> implements List<E>, RandomAccess {
     ...
     * @param collection the collection to be added from
     * @return boolean if it added correctly
    ...
    public boolean addAll(int index, Collection<? extends E> collection) {
        throw new UnsupportedOperationException("Not supported" +
                "since container maintains sorted order");
    }
